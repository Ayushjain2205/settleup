    ...
    return (
      <div className="min-h-screen bg-[var(--background)]">
        ...
        <main className="flex flex-col items-center justify-center py-24 px-6">
          ...
          <p className="text-sm font-medium text-[var(--foreground)]">Sign in to see your groups</p>
          <p className="text-xs text-[var(--muted)] mt-1 mb-4">Your shared expenses live here</p>
          <Link href="/login" className="px-4 py-2 bg-[var(--primary)] text-white rounded-lg text-xs font-semibold">
            Sign in
          </Link>
        </main>
        <BottomNav />
