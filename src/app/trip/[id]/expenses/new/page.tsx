...
export default function AddExpensePage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] flex flex-col">
      ...
      {/* Form */}
      <main className="flex-1 flex flex-col px-4 pt-8 pb-4">
        {/* Description */}
        <div className="flex items-center gap-3 mb-6">
          ...
          <input
            ...
            className="flex-1 text-[17px] text-[var(--foreground)] bg-transparent border-0 border-b-2 border-[var(--primary)] focus:outline-none pb-2 placeholder:text-[var(--muted)]/40 transition-colors"
            autoFocus
          />
        </div>
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <input
            ...
            placeholder="0"
            className="flex-1 text-[32px] font-bold text-[var(--foreground)] bg-transparent border-0 border-b-2 border-[var(--primary)] focus:outline-none pb-2 placeholder:text-[var(--border-color)] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
          />
        </div>
